...
import { ASSET_NAME } from './LandingPageOrigin.duck';
...
export const LandingPageOriginComponent = props => {
...
LandingPageOriginComponent.propTypes = {
...
const LandingPageOrigin = compose(connect(mapStateToProps))(LandingPageOriginComponent);

export default LandingPageOrigin;
